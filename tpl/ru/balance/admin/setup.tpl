...
{include file='edit.tpl' 
	...
	fields=[
		...
		'RateBTC'=>['$', '1 BTC ='],
		'UpdateBTCRate'=>['C', 'Обновлять курс BTC автоматически <<с сайта cryptonator.com>>'],
		'RateETH'=>['$', '1 ETH ='],
		'UpdateETHRate'=>['C', 'Обновлять курс ETH автоматически <<с сайта cryptonator.com>>'],
		'RateLTC'=>['$', '1 LTC ='],
		'UpdateLTCRate'=>['C', 'Обновлять курс LTC автоматически <<с сайта cryptonator.com>>'],
		'RateXRP'=>['$', '1 XRP ='],
		'UpdateXRPRate'=>['C', 'Обновлять курс XRP автоматически <<с сайта cryptonator.com>>'],
		'Update'=>['C', 'Обновлять балансы кошельков'],
		
		'Пополнение',
		'SumInInternal'=>['C', 'Ввод суммы в ед. внутренней валюты', 'skip' => !$_cfg.Const_IntCurr],
		'CASHINText'=>['T', 'Текст <<доступны #id#, #user#>>', 'size'=>30],
		'ForcePayer'=>['C', 'Выставлять <<фиксировать>> номер плательщика'],
		'AFMMode'=>['S', 'Ввод реквизитов платежа "вручную"', [], ['раздельный', 'сразу: account', 'сразу: batch', 'сразу: account+batch']],
